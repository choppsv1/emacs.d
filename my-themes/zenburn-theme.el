...
;;;;; irfc-mode
   `(irfc-head-name-face ((t (:foreground ,zenburn-orange))))
   `(irfc-head-number-face ((t (:foreground ,zenburn-orange))))
   `(irfc-reference-face ((t (:foreground ,zenburn-yellow-2 :underline t))))
   `(irfc-requirement-keyword-face ((t (:bold t :italic t :slant italic :weight bold))))
   `(irfc-rfc-link-face ((t (:foreground ,zenburn-yellow-2 :underline t))))
   `(irfc-rfc-number-face ((t (:bold t :weight bold))))
   `(irfc-std-number-face ((t (:bold t :weight bold))))
   `(irfc-table-item-face ((t (:foreground ,zenburn-yellow-2 :underline t))))
   `(irfc-title-face ((t (:foreground ,zenburn-orange))))
;;;;; jabber-mode
