...
(custom-theme-set-faces
 ...
 '(dired-warning ((t (:foreground "Red" :weight bold :bold t))))
 '(error ((t (:bold t :foreground "White" :background "#5f0000" :weight bold))))
 ...
 '(font-lock-doc-face ((t (:foreground "#eeee00"))))
 '(font-lock-function-name-face ((t (:bold t :foreground "#4186be" :weight bold))))
 ...
 '(mode-line ((t (:background "darkslateblue" :foreground "white" :box (:line-width -1 :style released-button)))))
 ;; '(mode-line-buffer-id ((t (:bold t :background "darkslateblue" :foreground "white" :weight bold))))
 ...
 '(warning ((t (:weight bold :foreground "White" :background "#afaf00" :bold t))))
